...
function load() {
    ...
    function square1() {
       if (turn == 0 && gameEnd != true && n1 == 0) {
           document.querySelector(".square1").style.backgroundImage = "url(Images/Tic-Tac-Toe-X.png)";
           i++;
           turn = i % 2;
           n1 = 1;
       } else if (turn == 1 && gameEnd != true && n1 == 0) {
           document.querySelector(".square1").style.backgroundImage = "url(Images/Tic-Tac-Toe-O.png)";
           i++;
           turn = i % 2;
           n1 = 2;
       }
    ...
    function square2() {
        if (turn == 0 && gameEnd != true && n2 == 0) {
            document.querySelector(".square2").style.backgroundImage = "url(Images/Tic-Tac-Toe-X.png)";
            i++;
            turn = i % 2;
            n2 = 1;
        } else if (turn == 1 && gameEnd != true && n2 == 0) {
            document.querySelector(".square2").style.backgroundImage = "url(Images/Tic-Tac-Toe-O.png)";
            i++;
            turn = i % 2;
            n2 = 2;
        }
     ...
     function square3() {
        if (turn == 0 && gameEnd != true && n3 == 0) {
            document.querySelector(".square3").style.backgroundImage = "url(Images/Tic-Tac-Toe-X.png)";
            i++;
            turn = i % 2;
            n3 = 1;
        } else if (turn == 1 && gameEnd != true && n3 == 0) {
            document.querySelector(".square3").style.backgroundImage = "url(Images/Tic-Tac-Toe-O.png)";
            i++;
            turn = i % 2;
            n3 = 2;
        }
     ...
     function square4() {
        if (turn == 0 && gameEnd != true && n4 == 0) {
            document.querySelector(".square4").style.backgroundImage = "url(Images/Tic-Tac-Toe-X.png)";
            i++;
            turn = i % 2;
            n4 = 1;
        } else if (turn == 1 && gameEnd != true && n4 == 0) {
            document.querySelector(".square4").style.backgroundImage = "url(Images/Tic-Tac-Toe-O.png)";
            i++;
            turn = i % 2;
            n4 = 2;
        }
     ...
     function square5() {
        if (turn == 0 && gameEnd != true && n5 == 0) {
            document.querySelector(".square5").style.backgroundImage = "url(Images/Tic-Tac-Toe-X.png)";
            i++;
            turn = i % 2;
            n5 = 1;
        } else if (turn == 1 && gameEnd != true && n5 == 0) {
            document.querySelector(".square5").style.backgroundImage = "url(Images/Tic-Tac-Toe-O.png)";
            i++;
            turn = i % 2;
            n5 = 2;
        }
     ...
     function square6() {
        if (turn == 0 && gameEnd != true && n6 == 0) {
            document.querySelector(".square6").style.backgroundImage = "url(Images/Tic-Tac-Toe-X.png)";
            i++;
            turn = i % 2;
            n6 = 1;
        } else if (turn == 1 && gameEnd != true && n6 == 0) {
            document.querySelector(".square6").style.backgroundImage = "url(Images/Tic-Tac-Toe-O.png)";
            i++;
            turn = i % 2;
            n6 = 2;
        }
     ...
     function square7() {
        if (turn == 0 && gameEnd != true && n7 == 0) {
            document.querySelector(".square7").style.backgroundImage = "url(Images/Tic-Tac-Toe-X.png)";
            i++;
            turn = i % 2;
            n7 = 1;
        } else if (turn == 1 && gameEnd != true && n7 == 0) {
            document.querySelector(".square7").style.backgroundImage = "url(Images/Tic-Tac-Toe-O.png)";
            i++;
            turn = i % 2;
            n7 = 2;
        }
     ...
     function square8() {
        if (turn == 0 && gameEnd != true && n8 == 0) {
            document.querySelector(".square8").style.backgroundImage = "url(Images/Tic-Tac-Toe-X.png)";
            i++;
            turn = i % 2;
            n8 = 1;
        } else if (turn == 1 && gameEnd != true && n8 == 0) {
            document.querySelector(".square8").style.backgroundImage = "url(Images/Tic-Tac-Toe-O.png)";
            i++;
            turn = i % 2;
            n8 = 2;
        }
     ...
     function square9() {
        if (turn == 0 && gameEnd != true && n9 == 0) {
            document.querySelector(".square9").style.backgroundImage = "url(Images/Tic-Tac-Toe-X.png)";
            i++;
            turn = i % 2;
            n9 = 1;
        } else if (turn == 1 && gameEnd != true && n9 == 0) {
            document.querySelector(".square9").style.backgroundImage = "url(Images/Tic-Tac-Toe-O.png)";
            i++;
            turn = i % 2;
            n9 = 2;
        }
